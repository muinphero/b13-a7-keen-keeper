      ...
      <div className="space-y-4 lg:col-span-8">
        <section className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <article className="rounded-lg border border-slate-200 bg-white px-6 py-7 text-center">
            <p className="text-[50px] font-extrabold leading-none text-[#1f5a49]">
          ...
          <article className="rounded-lg border border-slate-200 bg-white px-6 py-7 text-center">
            <p className="text-[50px] font-extrabold leading-none text-[#1f5a49]">{friend.goal}</p>
        ...
        <section className="rounded-lg border border-slate-200 bg-white p-6">
          <div className="flex items-start justify-between">
            <div>
              <h2 className="text-[28px] font-extrabold leading-none text-[#1f5a49]">Relationship Goal</h2>
              <p className="mt-3 text-[18px] leading-none text-slate-500">
                Connect every <span className="font-extrabold text-slate-700">{friend.goal} days</span>
              </p>
            </div>
        ...
        <section className="rounded-lg border border-slate-200 bg-white p-6">
          <h2 className="text-[28px] font-extrabold leading-none text-[#1f5a49]">Quick Check-In</h2>
          <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-3">
            <button className="rounded-lg border border-slate-200 bg-[#edf0f4] px-8 py-5 text-center">
